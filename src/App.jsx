...
function App() {
  ...
  useEffect(() => {
    ...
    const loadCategories = async () => {
      try {
        ...
        // If the current default category is not available,
        // select the first category from the database.
        if (
  ...
  const filteredTasks = useMemo(() => {
    ...
    const parseTaskDueDate = (task) => {
      ...
      const parsedWithYear = new Date(
        `${normalized}, ${today.getFullYear()}`
      );
  ...
  const handleUpdateTask = async (e) => {
    ...
    if (
      !selectedTask ||
      !taskDetailsForm.title.trim() ||
      !taskDetailsForm.dueDate
    ) {
      return;
    }
  ...
  const handleAIPlanTask = async () => {
    ...
    try {
      ...
      console.error(
        'AI task planning error:',
        error
      );

      alert(
        'Could not generate AI task suggestions.'
      );
    ...
    try {
      ...
      const demoTasks = [
...

        {
          ...
          description:
            'Update the project documentation and README.',
                ...
                <div className="task-details-body">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      type="text"
                      value={
                        taskDetailsForm.title
                      }
                      onChange={
                        handleTaskDetailsChange
                      }
                      required
                    />
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group">
                      ...
                      <label htmlFor="details-priority">
                        Priority
                      </label>
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group">
                      ...
                      <label htmlFor="details-category">
                        Category
                      </label>
                    ...
                    <div className="form-group">
                      ...
                      <label htmlFor="details-due-date">
                        Due date
                      </label>
                    ...
                    <div className="smart-analysis-panel">
                      ...
                      <div className="smart-analysis-grid">
                        ...
                        <div>
                          ...
                          <strong>
                            {
                              taskAnalysis.suggestedPriority
                            }
                          </strong>
                        </div>
                        ...
                        <div className="smart-analysis-action">
                          ...
                          <strong>
                            {
                              taskAnalysis.recommendedAction
                            }
                          </strong>
                      ...
                      <small>
                        Rule-based analysis — no external AI API used.
                      </small>
